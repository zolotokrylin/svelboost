...
import { PopupBody } from "./components/Popup";
...
export { Badge, Button, Breadcrumb, ButtonIcon, Icon, Heading, Paragraph, NavItem, CircularLoading, CookieManager, WalletProvider, MetamaskPopup, State, Dropdown, DropdownOption, DropdownOptions, Selector, SelectorOption, Tabs, Table, TableBody, TableHead, TableRow, TableCell, Tooltip, TxPopup, File, Form, Popup, PopupBody, PopupHeader, MetaTags, JSONLD, Select as FormSelector, Input, InputWithLabel, types, validator, focus, resize, clickOutside, portal };
