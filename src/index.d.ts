...
import { TabsHead } from "./components/Tabs";
import { TabsHeadItem } from "./components/Tabs";
import { TabsHeadGroup } from "./components/Tabs";
...
export { Badge, Button, Breadcrumb, ButtonIcon, Icon, Heading, NavItem, CircularLoading, CookieManager, WalletProvider, MetamaskPopup, State, Dropdown, DropdownOption, DropdownOptions, Selector, SelectorOption, Tabs, TabsHead, TabsHeadItem, TabsHeadGroup, Table, TableBody, TableHead, TableRow, TableCell, TxPopup, File, Form, Select as FormSelector, Input, types, validator, focus, resize, clickOutside, portal };
